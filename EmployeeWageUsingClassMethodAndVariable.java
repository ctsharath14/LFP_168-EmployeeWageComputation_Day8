public class EmployeeWageUsingClassMethodAndVariable {
    ...
    public static void main(String[] args) {
        ...
        EmployeeWageUsingClassMethodAndVariable empWageBuilder = new EmployeeWageUsingClassMethodAndVariable();
